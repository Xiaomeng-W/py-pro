...
class V2Char(CharFrame):
    ...
    def genCharVideo(self, file_path):
        self.charVideo = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('file', help='Video file or char video_file')
    parser.add_argument('-e', '--export', nargs='?', const='char_video.txt', help='Export char video_file')
    # 获取参数
